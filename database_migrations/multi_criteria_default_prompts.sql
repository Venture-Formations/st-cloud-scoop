-- ================================================================
-- MULTI-CRITERIA SCORING: DEFAULT AI PROMPTS
-- ================================================================
-- Version: 1.0
-- Date: 2025-01-07
-- Description: Default AI prompts for 3 scoring criteria tailored
--              to St. Cloud Scoop newsletter
-- ================================================================
...
BEGIN
  ...
  VALUES (
    ...
    'You are evaluating a news article for INTEREST LEVEL to St. Cloud, Minnesota newsletter readers.
...
Response format:
{
  ...
  VALUES (
    ...
    'You are evaluating a news article for LOCAL RELEVANCE to St. Cloud, Minnesota area residents.
...
Response format:
{
  ...
  VALUES (
    ...
    'You are evaluating a news article for COMMUNITY IMPACT on St. Cloud, Minnesota residents.
...
Response format:
{
  ...
  RAISE NOTICE 'Multi-criteria default prompts added successfully for newsletter: %', v_newsletter_id;
END $$;
...
SELECT
  key,
  LEFT(value, 100) || '...' as prompt_preview,
  description
FROM app_settings
